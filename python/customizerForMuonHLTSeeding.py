...
def customizerFuncForMuonHLTSeeding(
    ...
    process.hltIter3IterL3MuonPixelSeedsFiltered = cms.EDProducer("MuonHLTSeedMVAClassifier",
        ...
        mvaFile_B_0 = cms.FileInPath("dummy"),
        mvaFile_B_1 = cms.FileInPath("dummy"),
        mvaFile_B_2 = cms.FileInPath("dummy"),
        mvaFile_B_3 = cms.FileInPath("dummy"),
        mvaFile_E_0 = cms.FileInPath("dummy"),
        mvaFile_E_1 = cms.FileInPath("dummy"),
        mvaFile_E_2 = cms.FileInPath("dummy"),
        mvaFile_E_3 = cms.FileInPath("dummy"),
